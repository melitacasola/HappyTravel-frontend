    ...
    return (
        <div className="w-full sm:w-72 sm:h-9/11 lg:w-96 lg:h-9/11 xl:w-full xl:h-9/11 bg-white border-4 rounded-3xl border-yellow-100 p-5">
            ...
            <div className="flex flex-row items-center justify-center bg-white h-full rounded-b-xl pr-1 border-t-2 border-pink-500">
                <div className="bg-white h-full w-1/2 pt-6">
                    <div className="mr-7">
                        <label
                            htmlFor="small-input"
                        ...
                        <div className="relative inline-block h-auto w-full ">
                            ...
                            <input
                                id=""
                                type="file"
                                className="bg-yellow-100 w-full h-10 rounded-full shadow-[inset_0px_4px_4px_#00000040] placeholder:text-blue-500 placeholder:text-lg placeholder:font-light p-5" 
                                placeholder="Escribe tu nombre..."
                            />
                        </div>
                ...
                <div className="w-1/2 bg-white h-96 p-2 rounded-xl">
                    ...
                    <textarea
                        id="message"
                        rows="3"
                        className=" p-4 my-6 mt-1 h-80 w-full text-sm bg-yellow-100 rounded-3xl shadow-[inset_0px_4px_4px_#00000040] textarea-height font-jaldi placeholder:text-blue-500 placeholder:text-lg placeholder:font-light"
