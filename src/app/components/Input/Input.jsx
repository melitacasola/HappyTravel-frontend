...
const Input = ({ type, placeholder, validationMessage, value, onChange }) => {
  ...
  const inputStyle = `placeholder-text-color px-6 py-2 rounded-full text-xl shadow-[inset_0px_4px_4px_#00000040] transition-colors duration-300 bg-bg-color focus:outline-none focus:ring focus:ring-text-color w-72 text-text-color`;
